...
def GetLuminance_From_sRGB_Primaries_with_white_of_XYZ():
    a = np.array([
        [sRGB_Primary_R[0]/sRGB_Primary_R[1], sRGB_Primary_G[0] /
            sRGB_Primary_G[1], sRGB_Primary_B[0]/sRGB_Primary_B[1]],
        [1, 1, 1],
...
def GetMatrix_sRGB_to_XYZ():
    ...
    sRGB_to_XYZ = np.array([
        [sRGB_Primary_R[0]/sRGB_Primary_R[1]*Y[0], sRGB_Primary_G[0] /
            sRGB_Primary_G[1]*Y[1], sRGB_Primary_B[0]/sRGB_Primary_B[1]*Y[2]],
        [Y[0], Y[1], Y[2]],
        [(1.0-sRGB_Primary_R[0]-sRGB_Primary_R[1])/sRGB_Primary_R[1]*Y[0], (1.0-sRGB_Primary_G[0]-sRGB_Primary_G[1]
                                                                            )/sRGB_Primary_G[1]*Y[1], (1.0-sRGB_Primary_B[0]-sRGB_Primary_B[1])/sRGB_Primary_B[1]*Y[2]],
    ])
    return sRGB_to_XYZ
...
print('[Yr, Yg, Yb] : {0}'.format(
    GetLuminance_From_sRGB_Primaries_with_white_of_XYZ()))
print()
